...
| **Baudowl**| [github.com/iotsrg/Baudowl](https://github.com/iotsrg/baudowl) | Rust     | The Ultimate Serial Port Detective - Detects baud rates, scans UART, logs traffic. CLI-based UART toolkit for hardware hackers. |
